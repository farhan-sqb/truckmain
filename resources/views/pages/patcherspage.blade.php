...
@section('title')
    Dispatchers | {{ $sitename }}
@endsection

@section('styles')
    <link rel="stylesheet" href="{{ asset('assets/css/dispatchers.css') }}">
@endsection
            ...
            <div class="row">
                <div class="col-12">
                    <div class="workInner">
                        ...
                        <p class="subHeading">
                            Pulling certificates for your drivers and helping your business move forward has never been
                            easier. Easy access through desktop or mobile.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 mt-3 mt-md-0">
                            <div class="content">
                                ...
                                <p class="subHeading">Add the drivers, vehicles, and freight that you want covered. You’ll
                                    get the best policy based on your unique trucking business.</p>
                            </div>
                        </div>
